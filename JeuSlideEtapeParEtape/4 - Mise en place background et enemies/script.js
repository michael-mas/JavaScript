...
window.addEventListener('load', function(){
    ...
    class Enemy {
        ...
        update(){
            this.x--; // initalisation pour que l'enemi1 bouge vers la gauche
    ...
    //Lancer instance de la class enemy1
    ...
    function animate(){
       ...
       // background.update(); //Callback de la mise à jour de background
        ...
        enemy1.draw(ctx); //Appel draw dans animation avec ctx en argument pour dessiner enemy1
        enemy1.update(); // met a jour enemy1
