...
window.addEventListener('load', function(){
    ...
    class Player {
        ...
        update(input, deltaTime){ // connecter mouvement aux touches de contrôle par l'argument input
    ...
    function animate(timeStamp){
       ...
       // background.update(); //Callback de la mise à jour de background
        ...
        player.update(input, deltaTime); // Appel de l'argument input et deltaTime via update dans la boucle animation
